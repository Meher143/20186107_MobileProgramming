...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        String text = "Pubg is the most trending and addictive game";
        shareText(text);
    }
    ...
    void shareText(String s) {
        ...
        String title = "Sharing the Text";
        ShareCompat.IntentBuilder.from(this).setType(str).setChooserTitle(title).setText(s).startChooser();
    }
}